...
def test_matrix_matrix_sub():
    assert matrix_matrix_sub(A, B) == [[ 0, -2, -3],
                                    [-4, -4, -6],
                                    [-7, -8, -8]]


@raises(ShapeError)
def test_matrix_matrix_sub_checks_shapes():
    """Shape rule: the rows and columns of the matrices must be the same size."""
    matrix_matrix_sub(C, D)
...
def test_matrix_multiply():
    ...
    assert matrix_multiply(B, C) == [[8, 10],
                                    [20, 25],
                                    [32, 40]]
    assert matrix_multiply(C, D) == [[7, 6, 5],
                                    [5, 6, 7],
                                    [7, 6, 5]]
    assert matrix_multiply(D, C) == [[8, 10], [8, 10]]

@raises(ShapeError)
def test_matrix_multiply_checks_shapes():
